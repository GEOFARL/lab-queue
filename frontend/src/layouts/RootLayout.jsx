    ...
    <div className="min-h-screen bg-gray w-full flex flex-col">
      ...
      <div className={`${styles.flexCenter} px-8 md:px-16`}>
        <div className="w-full xl:max-w-[1100px] relative">
          ...
          <div className="w-[269px] h-[269px] bg-fuchsia-600 bg-opacity-40 rounded-full blur-[150px] absolute -top-[90px] -left-[13.5rem] z-0" />
          <div className="w-[269px] h-[269px] bg-black rounded-full bg-opacity-20 blur-[150px] absolute top-[450px] right-0 md:-right-[75px] z-0" />
          <Outlet />
        </div>
      </div>
